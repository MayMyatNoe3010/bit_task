        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                margin: const EdgeInsets.symmetric(vertical: Dimensions.marginS),
                child: Row(
                  children: [
                    Expanded(
                      flex: 1,
                      child: TimePickerWidget(label: Strings.lbStartTime, callback: (start){
                    ...
                    Expanded(
                      flex: 1,
                      child: TimePickerWidget(label: Strings.lbEndTime, callback: (end){
                        widget.endTime = end;
              ...
              DropDownWidget(selectedCallback: (value){
                widget.reminder = '$value';
                reminderInt = int.parse(widget.reminder);
              }, hint: 'Please select for alarm before task',
                itemList: [DropDownItem(name: '10 mins',id: 10), DropDownItem(name: '15 mins', id: 15)],
              ),
              SwitchWidget(title: widget.isRepeat ? 'Disable daily reminder' : 'Enable daily reminder',onClickCallback: (bool value){
              ...
              Container(
                ...
                child: ElevatedButton(onPressed: () async{
                  Task todo = Task(title: widget.tecTitle.text, note: widget.tecNotes.text, startTime: widget.startTime.toString(), endTime: widget.endTime.toString(), reminderTime: reminderInt, isRepeated: widget.isRepeat);
